...
s_Second_Mat = "orsirr_1";

s_Third_Mat = "bcsstk01";

# Primeira Matriz

s_LU_First_Mat_Display = strcat("Primeira matriz: ", s_First_Mat);
...
s_LU_Second_Mat_Display = strcat("Segunda matriz: ", s_Second_Mat);
...
s_LU_Third_Mat_Display = strcat("Terceira matriz: ", s_Third_Mat);
